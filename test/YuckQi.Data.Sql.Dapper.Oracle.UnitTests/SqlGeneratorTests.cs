...
namespace YuckQi.Data.Sql.Dapper.Oracle.UnitTests;
...
public class SqlGeneratorTests
{
    ...
    public void GenerateSearchQuery_WithSingleParameter_IsValid()
    {
        ...
        Assert.That(sql, Is.EqualTo("select \"Id\", \"Name\" from \"SurLaTable\" where (\"Name\" = :Name) order by \"Name\" desc offset 50 rows fetch first 50 rows only;"));
    }
