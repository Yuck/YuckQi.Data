...
{
    public class SearchProvider<TEntity, TKey, TScope, TRecord> : SearchProviderBase<TEntity, TKey, TScope> where TEntity : IEntity<TKey> where TKey : struct where TScope : IClientSessionHandle
    {
